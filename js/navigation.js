...
(function(){
  ...
  const settingsChildren=[['user-management.html','♙','User Management'],['history.html','◷','History']];
  ...
  function render(){
    ...
    settingsChildren.forEach(([href,ic,txt])=>{const a=document.createElement('a');a.href=href;if(isActive(href))a.className='active';const s=document.createElement('span');s.className='nav-icon';s.textContent=ic;a.append(s,document.createTextNode(txt));sub.appendChild(a)});
