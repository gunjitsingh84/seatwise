...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      /* ==========================================================
         SeatWise shared navigation
         The sidebar is a fixed 3-row shell:
           1. Brand (fixed)
           2. Navigation (scrolls internally)
           3. Profile/footer (fixed)
         This prevents the menu and profile from moving when pages
         have different amounts of navigation content.
         ========================================================== */
      .sidebar{
      ...
      .sidebar>.brand{height:92px!important;min-height:92px!important;}
      .sidebar>.nav{
      ...
      .sidebar .nav>a:hover,
      .sidebar .nav .nav-submenu>a:hover{background:rgba(255,255,255,.08)!important;}
      ...
      .sidebar .nav .nav-settings-arrow{margin-left:auto!important;transition:none!important;}
      ...
      @media(max-width:980px){
        .sidebar{position:fixed!important;left:0!important;top:0!important;bottom:0!important;z-index:1000!important;}
        .sidebar>.nav{overflow-y:auto!important;}
      }
      @media(max-width:650px){
        .sidebar{position:fixed!important;left:0!important;top:0!important;bottom:0!important;width:270px!important;height:100vh!important;min-height:100vh!important;}
        .sidebar>.nav{display:block!important;overflow-y:auto!important;padding:28px 15px!important;}
  ...
  function render(){
    ...
    if(!nav)return;
    nav.classList.remove('seatwise-nav-ready');
    nav.replaceChildren();
    ...
    /* Reveal only after the complete menu is in the DOM. */
